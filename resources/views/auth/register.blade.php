              ...
              <div class="card-body p-5">
                  ...
                  <div class="row g-3 my-4">
                    <div class="col-12 col-lg-6">
                      <button class="btn btn-light py-2 font-text1 fw-bold d-flex align-items-center justify-content-center w-100"><img src="{{asset('admin')}}/assets/images/icons/google-2.png" width="18" class="me-2" alt="">Sign Up with Google</button>
                    </div>
                    <div class="col col-lg-6">
                      <button class="btn btn-light py-2 font-text1 fw-bold d-flex align-items-center justify-content-center w-100"><img src="{{asset('admin')}}/assets/images/icons/apple-logo.png" width="18" class="me-2" alt="">Sign Up with Apple</button>
                    </div>
                  </div>
